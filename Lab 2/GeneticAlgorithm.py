...
# Function for generating probability list from fitness list  
...
def crossover(x,y):
    ...
    select = np.random.choice(3, start_population)
    for i in select:
        if i == 0:
...
mutation_threshold = 0.3        # Mutation Threshold
...
ap_array = []
fit_list = []
a = [i for i in range(start_population)]
